        ...
        <div class="col-md-5 bg-white p-5">
          ...
          <form @submit.prevent="submitForm">
            ...
            <div class="mb-3 inputs">
              ...
              <input type="text" id="fullName" v-model="fullName" class="form-control border-0" required />
            </div>
            
            <!-- Email -->
            <div class="mb-3 inputs">
              <label for="email" class="form-label">Email</label> 
              <input type="email" id="email" v-model="email" class="form-control border-0" required />
            ...
            <div class="mb-3 inputs">
              ...
              <input type="password" id="password" v-model="password" class="form-control border-0" required minlength="8" />
